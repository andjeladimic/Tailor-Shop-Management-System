            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPasswordField, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonUlogujSeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUlogujSeActionPerformed
        try {
            ...
            if (jTextFieldUsername.getText().isEmpty()
                    || new String(jPasswordField.getPassword()).isEmpty()) {
                JOptionPane.showMessageDialog(this, "Morate uneti korisnicko ime i lozinku.");
                return;
            }

            Krojacica k = new Krojacica();
            k.setUsername(jTextFieldUsername.getText());
            k.setPassword(new String(jPasswordField.getPassword()));
            k.setIme("");
            k.setPrezime("");

            Krojacica krojacica = ClientController.getInstance().login(k);
            Session.getInstance().setUlogovana(krojacica);
