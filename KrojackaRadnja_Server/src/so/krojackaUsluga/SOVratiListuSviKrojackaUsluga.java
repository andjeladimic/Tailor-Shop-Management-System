 ...
 * @author Andjela
 */
public class SOVratiListuSviKrojackaUsluga extends AbstractSO {
    ...
    protected void execute(AbstractDomainObject ado) throws Exception {
        ArrayList<AbstractDomainObject> listaKrojackihUsluga = DBBroker.getInstance().select(ado);
        lista = (ArrayList<KrojackaUsluga>) (ArrayList<?>) listaKrojackihUsluga;
    }
